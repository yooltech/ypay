...
/**
 * Class Payment
 * @property \YPay\Api\Payer payer
 * @property \YPay\Api\Transaction transaction
 * @property \YPay\Api\RedirectUrls redirectUrls
 * @property array credentials
 * @property string approvedUrl
 *
 */
class Payment extends YPayModel
{

    /**
     * @param \YPay\Api\Payer $payer
     *
     * @return $this
     */
    ...
    /**
     * @param \YPay\Api\Transaction $transaction
     *
     * @return $this
     */
    ...
    /**
     * @param \YPay\Api\RedirectUrls $redirectUrls
     *
     * @return $this
     */
    ...
    private function getAccessToken()
    {
        ...
        $res = $this->execute(YPAY_BASE_URL . 'merchant/api/verify', 'post', $payload);
        $res = json_decode($res);
    ...
    private function sendTransactionInfo($token)
    {
        ...
        $res = $this->execute(YPAY_BASE_URL . 'merchant/api/transaction-info', 'POST', $req, $header);
        $res = json_decode($res);
